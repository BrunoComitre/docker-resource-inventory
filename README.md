# Docker Resource Inventory :computer:

<u>*A Docker repository to facilitate studies.*</u>
...
<u>*This part is for Young Padawans or Jedi in Docker Study*</u>
...
- [Certification Docker DCA](#certification-docker-dca)
...
Below is a list of favorite sites that have a variety of topics related to Docker in general:
...
- [File system sharing (osxfs)](https://docs.docker.com/docker-for-mac/osxfs/#namespaces) [EN-US]
...
Below is a list of personal and company websites aimed at Docker in general:
